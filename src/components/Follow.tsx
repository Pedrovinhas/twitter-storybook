...
export function Follow(props: FollowProps) {
    return (
        ...
        <a className="flex  gap-4 pt-2 pb-2 cursor-pointer border-b-dark-7 border-[1px] border-t-0 border-l-0 border-r-0 border-opacity-5 hover:bg-dark-4  transition-all duration-150"> 
