...
export function News(props: NewsProps) {
    return (
        <div className='bg-dark-8 flex flex-col w-[350px] rounded-2xl dark:bg-dark-2'>
            ...
            <a className="flex justify-center gap-4 pt-2 pb-2 cursor-pointer border-b-dark-7 border-[1px] border-t-0 border-l-0 border-r-0 border-opacity-5 hover:bg-dark-4  transition-all duration-150"> 
            ...
            <a href="" className='pt-3 pb-3 rounded-b-2xl hover:bg-dark-4  duration-300'>
